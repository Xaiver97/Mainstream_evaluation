        ...
        for epoch in range(1, self.epoch + 1):
            ...
            if epoch % self.display == 0:
                ...
                if np.mean(ndcg) > best_result:
                    ...
                    with open('../mod_data/' + self.data + '/rec_res/Res_VAE.npy', "wb") as f:
...
if __name__ == '__main__':
    ...
    train_like = list(np.load('../mod_data/' + args.data + '/sep_data/user_train_like.npy', allow_pickle=True))
    test_like = list(np.load('../mod_data/' + args.data + '/sep_data/user_test_like.npy', allow_pickle=True))
    vali_like = list(np.load('../mod_data/' + args.data + '/sep_data/user_vali_like.npy', allow_pickle=True))
